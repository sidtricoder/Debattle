...
import { Eye, EyeOff, Mail, Lock, User, AlertCircle, CheckCircle, Target, Gift } from 'lucide-react';
...
const RegisterForm: React.FC<RegisterFormProps> = ({ onSwitchToLogin }) => {
  ...
  const { signInWithGoogle, signUp, error, clearError } = useAuthStore();
    ...
    >
      ...
      <div className="mb-6">
        <div className="flex items-center justify-center space-x-4 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-600 dark:text-gray-400">Choose Your Arena</span>
          </div>
          <div className="w-8 h-1 bg-gray-300 dark:bg-gray-600"></div>
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-gray-300 dark:bg-gray-600 rounded-full flex items-center justify-center">
            ...
            <span className="text-gray-600 dark:text-gray-400">Ready to Debate!</span>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6 p-4 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg border border-green-200 dark:border-green-800">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm">
            <div className="font-semibold text-green-800 dark:text-green-200 mb-1">Welcome Bonus:</div>
            <ul className="text-green-700 dark:text-green-300 space-y-1">
              <li>✨ Instant access to 10,000+ debate topics</li>
              <li>🏆 Start with 1200 ELO rating</li>
              <li>🎁 3 practice debates with AI</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      {error && (
        ...
        >
          ...
          <p className="text-red-700 dark:text-red-400 text-sm">Oops! Something went wrong. Let's try again!</p>
        </motion.div>
      )}
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              id="email"
              className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors"
              placeholder="Enter your debate champion email"
            />
          </div>
          {errors.email && (
            <motion.p
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Create your fortress password"
            />
            <button
              type="button"
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              id="confirmPassword"
              className="w-full pl-10 pr-12 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors"
              placeholder="Confirm your fortress password"
            />
            <button
              type="button"
        ...
        <motion.button
          ...
          type="submit"
          disabled={isLoading}
          className="w-full bg-gradient-to-r from-green-600 to-teal-600 text-white py-3 px-4 rounded-lg font-medium hover:from-green-700 hover:to-teal-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
        >
          {isLoading ? (
            <div className="flex items-center justify-center">
              <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin mr-2"></div>
              Preparing your debate arsenal...
            </div>
          ) : (
            <span className="flex items-center justify-center gap-2">
              🎯 Claim My Spot in the Arena
