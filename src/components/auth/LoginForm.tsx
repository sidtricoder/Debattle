...
import { Eye, EyeOff, Mail, Lock, AlertCircle, Sword } from 'lucide-react';
    ...
    >
      {error && (
        ...
        >
          ...
          <p className="text-red-700 dark:text-red-400 text-sm">Oops! Check your credentials, champion!</p>
        </motion.div>
      )}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Enter your debate arena email"
            />
          </div>
          {errors.email && (
            <motion.p
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Enter your secret weapon"
            />
            <button
              type="button"
      ...
      <div className="mt-8 text-center">
        <p className="text-gray-600 dark:text-gray-400">
          ...
          >
            <strong>Join the elite debaters</strong> →
          </button>
        </p>
      </div>
    </motion.div>
